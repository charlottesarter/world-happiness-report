...
<<<<<<< HEAD
  labs(title = "Corrélation entre la liberté et le bonheur (2021)", 
       ...
       y = "Score de bonheur")
=======
  labs(title = "Corrélation entre la liberté et le bonheur (2021)", x = "Niveau de liberté", y = "Score de bonheur", color = "Continent")
>>>>>>> 8d1d08038c5c152812c25ae39776f135cefe8670
...
gpd_correlation_graph <- data %>%
  filter(Year == 2021) %>%
<<<<<<< HEAD
  ggplot(aes(x=Logged_gpd_per_capita, y=Happiness_score, text = paste("Country: ", Country, "\n", "Rank: ", Happiness_rank))) +
  geom_point(aes(color = Continent)) + 
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
...
life_expectancy_correlation_graph <- data %>%
  filter(Year == 2021) %>%
  ggplot(aes(x=Life_expectancy, y=Happiness_score, text = paste("Country: ", Country, "\n", "Rank: ", Happiness_rank))) + 
  geom_point(aes(color = Continent)) + 
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
...
social_support_correlation_graph <- data %>%
  filter(Year == 2021) %>%
  ggplot(aes(x=Social_support, y=Happiness_score, text = paste("Country: ", Country, "\n", "Rank: ", Happiness_rank))) + 
  geom_point(aes(color = Continent)) + 
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
...
=======
  ...
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
              ...
              se = FALSE,
              size = 1) + 
  labs(title = "Corrélation entre le PIB par habitant et le bonheur (2021)", x = "Score de PIB par habitant", y = "Score de bonheur", color = "Continent")
...
life_expectancy_correlation_graph <- data %>%
  ...
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
              ...
              se = FALSE,
              size = 1) + 
  labs(title = "Corrélation entre l'espérance de vie et le bonheur (2021)", x = "Espérance de vie", y = "Score de bonheur", color = "Continent")
...
social_support_correlation_graph <- data %>%
  ...
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
              ...
              se = FALSE,
              size = 1) + 
  labs(title = "Corrélation entre le support social et le bonheur (2021)", x = "Support social", y = "Score de bonheur", color = "Continent")
>>>>>>> 8d1d08038c5c152812c25ae39776f135cefe8670
...
generosity_correlation_graph <- data %>%
  filter(Year == 2021) %>%
<<<<<<< HEAD
  ggplot(aes(x = Generosity, y = Happiness_score, text = paste("Country: ", Country, "\n", "Rank: ", Happiness_rank))) +
  geom_point(aes(color = Continent)) + 
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
...
trust_government_correlation_graph <- data %>%
  filter(Year == 2021) %>%
  ggplot(aes(x = Trust_government, y = Happiness_score, text = paste("Country: ", Country, "\n", "Rank: ", Happiness_rank))) +
  geom_point(aes(color = Continent)) + 
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
              aes(x = Trust_government, y = Happiness_score),
              #method = "lm",
              col = "#C42126",
              se = FALSE,
              size = 1) + 
  labs(title = "Corrélation entre la confiance dans le gouvernement et le bonheur (2021)", 
       x = "Niveau de confiance dans le gouvernement", 
       y = "Score de bonheur")
=======
  ggplot(aes(x = Generosity, y = Happiness_score, text = paste("Country: ", Country, "\n", "Rank: ", Happiness_rank))) + 
  geom_point(aes(color = factor(Continent))) + 
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
              ...
              se = FALSE,
              size = 1) + 
  labs(title = "Corrélation entre la générosité et le bonheur (2021)", x = "Score de générosité", y = "Score de bonheur", color = "Continent")
...
trust_government_correlation_graph <- data %>%
  ...
  geom_smooth(inherit.aes = FALSE, ## on est obligé de redéfinir l'aes ici à cause du text = paste dans l'aes ggplot
              ...
              se = FALSE,
              size = 1) + 
  labs(title = "Corrélation entre la confiance dans le gouvernement et le bonheur (2021)", x = "Score de confiance dans le gouvenement", y = "Score de bonheur", color = "Continent")
>>>>>>> 8d1d08038c5c152812c25ae39776f135cefe8670
