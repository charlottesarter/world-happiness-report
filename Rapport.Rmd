...
mean_hs_score_world <- data %>% 
  ...
  ggplot(aes(x = Year, 
             y = Happiness_score,
             text = paste("Year: ", Year, "\n", "Global Happiness Score: ", round(Happiness_score,2)))) + 
...
On constate immédiatement à la visualisation de ce graphique que le sentiment de liberté, comme on pouvait légitimement s'y attendre, est bien corrélé au score de bonheur des différents pays. Plus les habitants d'un pays se sentent libres, plus ils sont heureux.
...
On peut une fois encore observer une corrélation positive entre ces derniers facteurs et le score de bonheur.
