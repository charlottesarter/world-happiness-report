...
4.  **Analyse géographique** : Y'a-t-il des régions du monde moins heureuses que d'autres ? Pourquoi ? ➡️ Utiliser les facteurs de contribution du score pour mettre en évidence des causes de disparité
...
region_ranking_graph <- region_ranking_data %>%
  ...
  geom_bar(stat = "identity",
           fill = purples(10)) +
  labs(title = "Classement des régions les plus heureuses (année 2021)", 
       x = "Score de bonheur", 
       y = "Région") +
...
Cette deuxième partie s'attachera à répondre à la question *"Comment a évolué le bonheur au fil des années disponibles dans notre dataset (de 2015 à 2021) ?"* Le déroulement de l'analyse nous amènera par la suite à diviser cette question en plusieurs sous-questions moins vastes.
...
Analyse temporelle ou géographique ???
...
pollution_correlation_graph <- data2021_complement %>%
  ...
  geom_smooth(aes(x = Pollution_score, 
                  y = Happiness_score),
                  col = "#92be72",
                  se = FALSE,
                  size = 1) + 
  labs(title = "Corrélation entre le niveau de pollution et le bonheur (2021)", 
...
# IV) Quelle combinaison de facteurs hauts entraîne une hausse du bonheur ?
