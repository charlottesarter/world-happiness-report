...
*Attention: on peut penser à première vue que les variations du bonheur moyen au fil des ans est importante. Il est important de prendre en compte l'échelle de l'axe: ces variations sont en réalité relativement faibles, cette échelle ayant précisément été choisie pour qu'elles soient plus visuelles.*
...
Cette visualisation sous forme d'histogramme permet de visualiser assez rapidement le score de bonheur le plus présent dans une région. Le score de chaque pays est arrondi à l'entier le plus proche. Le graphique prend donc compte de chacun des scores individuellement puis s'organise suivant les régions.
...
```
>>>>>>> a78135e92e995a16455eae1d2e2aa200ac7d34a5
