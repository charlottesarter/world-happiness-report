...
Les cartes suivantes ont toutes été réalisées sur **Tableau**, et intégrées au rapport via des fichiers .png trouvables dans le dossier *\data*. L'intégralité de nos réalisations sur Tableau sont également disponibles dans le fichier "visualisations_tableau.twb".  
