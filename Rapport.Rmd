...
Nous avons voulu préciser l'analyse obtenue via le précédent graphique, en nous demandant quelles étaient les tendances de contribution des facteurs **dans chaque région**. Plusieurs constats nous ont alors frappé:  

-   Dans les régions développées, qui sont aussi globalement les plus heureuses, la tendance reste semblable 
